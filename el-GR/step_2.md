...
![Ο ιστότοπος του Scratch Lab με ένα βέλος που δείχνει την ένδειξη "Face Sensing".](images/facial-recognition.png)
...
![Ένα αναδυόμενο παράθυρο που ζητά άδεια χρήσης της κάμερας web, με ένα βέλος που δείχνει "Να επιτρέπεται κατά την επίσκεψη".](images/allow-webcam.png)
...
![Μια έκδοση του λογισμικού Scratch με πράσινα μπλοκ "Face Sensing".](images/scratch-special.png)