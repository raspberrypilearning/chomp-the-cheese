...
Якщо браузер запитає дозвіл на використання твоєї вебкамери, натисни **Дозволити під час відвідування сайту**.

![Спливне вікно із запитом дозволу на використання вебкамери зі стрілкою, що вказує на «Дозволити під час відвідування сайту».](images/allow-webcam.png)
